...
/*
 * @GPIO_PIN_PUPD
 * GPIO pin possible PULLUP & PULLDOWN configuration macros
 * */
 ...
 * Config = set up the bell. Priority = how urgent. Handling = what to do when it rings.
 * */
